...
<form id="bbp-your-profile" method="post" enctype="multipart/form-data">
    ...
    if(bbp_is_user_home() && !empty(get_option('civi-bb-groups-account-page', 0))): 
        $p = absint(get_option('civi-bb-groups-account-page', 0));
	    $link = get_permalink($p);
	    
	    if($link): 
	        echo "<a class='button btn btn-primary' href='".esc_url($link)."'>Edit your account here</a>";
	    endif;
